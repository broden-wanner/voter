...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      }), _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["IonicStorageModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _providers_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./providers/auth.interceptor */
    ...
    var _providers_auth_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _providers_auth_service__WEBPACK_IMPORTED_MODULE_11__["AuthService"], {
        provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"],
        useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"]
      }, {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HTTP_INTERCEPTORS"],
        useClass: _providers_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__["AuthInterceptor"],
        multi: true
      }],
  ...
  /***/
  function srcAppProvidersAuthInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
        ...
        value: function intercept(request, next) {
          if (this.authService.isLoggedIn()) {
            request = request.clone({
              setHeaders: {
                Authorization: "Token ".concat(this.authService.getUserToken())
              }
            });
          }
  ...
  function srcAppProvidersAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AuthService(http) {
        ...
        this.http = http; // Load the user from local storage upon loading

        var userJSON = JSON.parse(localStorage.getItem('current_user'));
        this.currentUser = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](userJSON);
      }
      /**
      ...
      _createClass(AuthService, [{
        ...
        value: function login(credentials) {
          ...
          return this.http.post("/accounts/login/", credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
            _this2.setSession(data);

            _this2.currentUser.next(data.user);
          }));
        }
        /**
        ...
        value: function logout() {
          ...
          return this.http.post("/accounts/logout/", {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
            _this3.removeSession();

            _this3.currentUser.next(null);
        ...
        key: "register",
        value: function register(newCredentials) {
          var _this4 = this;

          return this.http.post("/accounts/register/", newCredentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (userData) {
            return _this4.setSession(userData);
        ...
        value: function isLoggedIn() {
          var expirationDate = localStorage.getItem('token_expiry_date');
        ...
        key: "getCurrentUserObs",
        value: function getCurrentUserObs() {
          return this.currentUser.asObservable();
        }
        /**
         * Sets the user on the auth class
         *
         * @param user
         */
        ...
        key: "getCurrentUserValue",
        value: function getCurrentUserValue() {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/broden/workspace/voter/frontend/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
